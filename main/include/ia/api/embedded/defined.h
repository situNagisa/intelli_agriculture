...
using i2c_message = ngs::embedded::io::bus::i2c::message;
using namespace ngs::embedded::io::bus::i2c::modes;
...
using spi_slave = ngs::embedded::io::bus::spi::slave;
using namespace ngs::embedded::io::bus::spi::modes;
...
using i2c_master = ngs::embedded::io::bus::i2c::master;
using i2c_slave = ngs::embedded::io::bus::i2c::slave;
using i2c_message = ngs::embedded::io::bus::i2c::message;
using namespace ngs::embedded::io::bus::i2c::modes;

using ngs::embedded::io::frequency_t;

using spi_master = ngs::embedded::io::bus::spi::master;
using spi_device = ngs::embedded::io::bus::spi::device;
using spi_slave = ngs::embedded::io::bus::spi::slave;
using namespace ngs::embedded::io::bus::spi::modes;
